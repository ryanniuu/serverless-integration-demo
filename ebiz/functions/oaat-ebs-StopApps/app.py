   ...
   # if reservations['ResponseMetadata']['HTTPStatusCode'] == 200:
    ...
    for reservation in reservations:
        for instance in reservation["Instances"]:
             ...
             Parameters={
               "commands": ["runuser -l  applmgr -c 'cd clone_auto; sh appctl -source_db "+src_db+" -target_db "+tgt_db+" -action TARGET_PREP -phase STOP_APPS'"]
            },  # Command to Stop APP Service
        ) 
        ...
        if response['ResponseMetadata']['HTTPStatusCode'] != 200:
           raise Exception ("Issue in Stopping App Service")
