   ...
   # if reservations['ResponseMetadata']['HTTPStatusCode'] == 200:
    ...
    for reservation in reservations:
        for instance in reservation["Instances"]:
             ...
             Parameters={
               "commands": ["runuser -l  oracle -c 'cd clone_auto; sh dbctl-erp -source_db "+src_db+" -target_db "+tgt_db+" -action TARGET_PREP -phase STOP_DB'"]
            },  # Command to Stop EBS DB Service
        ) 
        ...
        if response['ResponseMetadata']['HTTPStatusCode'] != 200:
           raise Exception ("Issue in Stopping Database Servic")
